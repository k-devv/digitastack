<footer style="border-top: 1px solid var(--border); background: var(--surface); padding: 2rem 0; margin-top: 4rem;">
    <div class="container" style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 1.5rem;">
        <div>
            <p style="font-weight: 600; margin-bottom: 0.5rem;">DigitalStack</p>
            <p style="color: var(--muted); font-size: 0.875rem;">AI tools, SEO insights, and digital strategies that actually work.</p>
        </div>
    ...
    <div class="container" style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid var(--border);">
